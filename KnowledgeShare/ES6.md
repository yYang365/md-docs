...
![图片1](http://cdn.alloyteam.com/wp-content/uploads/2016/03/%E5%9B%BE%E7%89%871.png)
...
![图片3](http://cdn.alloyteam.com/wp-content/uploads/2016/03/%E5%9B%BE%E7%89%873.png)
...
在ES6中有更加严谨的版本，参数需要被包含在括号里并且它是隐式的返回：
    ...
    var messages = ids.map((value, index, list) =>
        `ID of ${index} element is ${value}`); // implicit return
...
在ES5中，main.js需要依赖 `require('module')` 导入 module.js：
